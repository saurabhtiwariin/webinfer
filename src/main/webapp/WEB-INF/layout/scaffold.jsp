...
<body>
			...
			<div class="navbar-inner">
				<div class="container">
					...
					<div>
						<nav>
							<ul class="nav topnav">
								<li class="dropdown success active"><a
									href='<spring:url value="/index.html"/>'><i
                    ...
                    <li><a href="index_alt2.html">Index alt 2</a></li> -->
								...
								<li class="dropdown primary"><a
									href='<spring:url value="#services"/>'><i
										class="icon-star icon-white"></i> Services</a>
									<ul class="dropdown-menu">
                    ...
                    <li class="dropdown"><a href="#">3rd level</a>
                      <ul class="dropdown-menu sub-menu">
                        ...
                        <li><a href="#">Example menu</a></li>
								...
								<li class="dropdown danger"><a
									href="#works"><i
										class="icon-leaf icon-white"></i> Works</a>
									<ul class="dropdown-menu">
                    ...
                    <li><a href="portfolio-detail.html">Portfolio detail</a></li> -->
								...
								<li class="dropdown info"><a
									href="#"><i
										class="icon-bullhorn icon-white"></i> FAQ</a>
									<ul class="dropdown-menu">
 ...
 ================================================== -->
				...
				<div class="span4">
					<div class="widget">
						...
						<address>
							...
							</strong><br> <spring:message
									code='index.app.contactus.addressline1' /><br> 
									<spring:message
									code='index.app.contactus.addressline2' /><br> 
									<abbr title="Phone">P:</abbr> <spring:message
									code='index.app.contactus.phone' /><br> 
									<abbr title="Phone">WhatsApp:</abbr> <spring:message
						...
						<address>
							...
							<a href='mailto:<spring:message
									code="index.app.contactus.email1" />'><spring:message
									code='index.app.contactus.email1' /></a>
									<br> 
							<a href='mailto:<spring:message
									code="index.app.contactus.email2" />'><spring:message
	...
	<script
		src="/resources/scaffold/assets/js/google-code-prettify/prettify.js"></script>
	...
	<script
		src="/resources/scaffold/assets/js/hover/jquery-hover-effect.js"></script>
